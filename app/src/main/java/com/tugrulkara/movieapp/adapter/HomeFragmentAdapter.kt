...
class HomeFragmentAdapter @Inject constructor():RecyclerView.Adapter<HomeFragmentAdapter.RowHolder>() {
    ...
    override fun onBindViewHolder(holder: RowHolder, position: Int) {
        ...
        movieList[position].posterPath?.let {
            holder.itembinding.posterIv.downloadFromUrl(POSTER_URL+it, placeholderProgressBar(holder.itemView.context))
        }
